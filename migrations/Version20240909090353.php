 ...
 */
final class Version20240909090353 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE licence (id INT NOT NULL, titrel VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
    }
